...
/// @title Bees
/// @author Rohan Kulkarni remixed by defijesus.eth
/// @notice A DAO's ERC-721 governance token
contract Bees is IToken, UUPS, Ownable, ReentrancyGuard, ERC721Votes, TokenStorageV1 {
    ///                                                          ///
    ///                         IMMUTABLES                       ///
    ///                                                          ///
    ...
    uint256 public constant MINT_OFFSET = 20_000;
    ...
    function mint() external nonReentrant returns (uint256 tokenId) {
        ...
        unchecked {
            do {
                ...
                tokenId = MINT_OFFSET + settings.mintCount++;
